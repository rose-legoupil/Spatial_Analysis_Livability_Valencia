...
output:
  html_document:
    toc: true
    toc_depth: 1
    css: tufte.css  #  Use a Tufte-inspired CSS
...
## Research Question and Introduction{#research-question-and-introduction}
...
## Measuring Affordability{#measuring-affordability}
...
## Measuring Social Diversity{#measuring-social-diversity}
...
## Measuring Accessibility{#measuring-accessibility}
...
ggplot() +
  # District borders
  geom_sf(data = District_filtered, fill = NA, color = "black", linewidth = 0.5) +
...
## Measuring Economic Vitality{#measuring-economic-vitality}
...
## Measuring Environmental Quality{#measuring-environmental-quality}
...
ggplot(final3_data, aes(x = environmental_quality, y = livability, size = income, color = district)) +
  ...
  scale_size(range = c(5, 20)) +  # **Increased Bubble Size**
  labs(title = "Fig. 17 Livability vs Environmental Quality",
    ...
    ggthemes::theme_tufte() +
  theme(
    axis.title.x = element_text(size = 10, face = "bold"),  # **Larger X-axis text**
    axis.title.y = element_text(size = 10, face = "bold"),  # **Larger Y-axis text**
    legend.text = element_text(size = 12),  # **Bigger Legend Text**
    legend.title = element_text(size = 12, face = "bold")  # **Bigger Legend Title**
  )
...
1. **Martino, N.**, Girling, C., & Lu, Y. (2021). *Urban Form and Livability: Socioeconomic and Built Environment Indicators*. *Buildings & Cities*, 2(1). [doi:10.5334/bc.82](https://doi.org/10.5334/bc.82) | [URL](https://journal-buildingscities.org/articles/10.5334/bc.82) (Accessed: 2024-09-26)

2. **Gaglione, F.**, Gargiulo, C., Zucaro, F., & Cottrill, C. (2022). *Urban Accessibility in a 15-Minute City: A Measure in the City of Naples, Italy*. *Transportation Research Procedia*, 60, 378-385. [doi:10.1016/j.trpro.2021.12.049](https://doi.org/10.1016/j.trpro.2021.12.049)

3. **Ingram, D.R.** (1971). *The Concept of Accessibility: A Search for an Operational Form*. *Regional Studies*, 5(2), 101-107. [doi:10.1080/09595237100185131](https://doi.org/10.1080/09595237100185131)

4. **Zhan, D.**, Kwan, M.-P., Zhang, W., Fan, J., Yu, J., & Dang, Y. (2018). *Assessment and Determinants of Satisfaction with Urban Livability in China*. *Cities*, 79, 92-101. [doi:10.1016/j.cities.2018.02.025](https://doi.org/10.1016/j.cities.2018.02.025)

5. **Frank, L.D.**, Sallis, J.F., Saelens, B.E., Leary, L., Cain, K., Conway, T.L., & Hess, P.M. (2009). *The Development of a Walkability Index: Application to the Neighborhood Quality of Life Study*. *British Journal of Sports Medicine*, 44(13), 924-933. [doi:10.1136/bjsm.2009.058701](https://doi.org/10.1136/bjsm.2009.058701)

6. **Moroni, S.** (2016). *Urban Density After Jane Jacobs: The Crucial Role of Diversity and Emergence*. *City, Territory and Architecture*, 3(1). [doi:10.1186/s40410-016-0041-1](https://doi.org/10.1186/s40410-016-0041-1)

7. **Abdul Shakur, E.S.**, Mohamed, A.F., & Abdul Hadi, A.S. (2017). *Housing Affordability Factors for Urban Liveability - A Preliminary Study*. *International Journal of Property Sciences*, 7(1), 1-14. [doi:10.22452/ijps.vol7no1.1](https://doi.org/10.22452/ijps.vol7no1.1)

8. **Farzin, Y.H.** & Bond, C.A. (2006). *Democracy and Environmental Quality*. *Journal of Development Economics*, 81(1), 213-235. [doi:10.1016/j.jdeveco.2005.04.003](https://doi.org/10.1016/j.jdeveco.2005.04.003)

9. **Gough, M.Z.** (2015). *Reconciling Livability and Sustainability*. *Journal of Planning Education and Research*, 35(2), 145-160. [doi:10.1177/0739456x15570320](https://doi.org/10.1177/0739456x15570320)

10. **Gallego-Valadés, A.**, Ródenas-Rigla, F., & Garcés-Ferrer, J. (2021). *Spatial Distribution of Public Housing and Urban Socio-Spatial Inequalities: An Exploratory Analysis of the Valencia Case*. *Sustainability*, 13(20), 11381. [doi:10.3390/su132011381](https://doi.org/10.3390/su132011381)

11. **Rodríguez, Á.M.** (2024). *Social Inequality and Residential Segregation Trends in Spanish Global Cities. A Comparative Analysis of Madrid, Barcelona, and Valencia (2001-2021)*. *Cities*, 149, 104935. [doi:10.1016/j.cities.2024.104935](https://doi.org/10.1016/j.cities.2024.104935)

12. **Bentlage, M.**, Müller, C., & Thierstein, A. (2020). *Becoming More Polycentric: Public Transport and Location Choices in the Munich Metropolitan Area*. *Urban Geography*, 42(1), 79-102. [doi:10.1080/02723638.2020.1826729](https://doi.org/10.1080/02723638.2020.1826729)

13. **Domański, B.** & Gwosdz, K. (2010). *Multiplier Effects in Local and Regional Development*. *Quaestiones Geographicae*, 29(2), 27-37. [doi:10.2478/v10117-010-0012-7](https://doi.org/10.2478/v10117-010-0012-7)

14. **Calafate, C.T.**, Soler, D., Cano, J.-C., & Manzoni, P. (2015). *Traffic Management as a Service: The Traffic Flow Pattern Classification Problem*. *Mathematical Problems in Engineering*, 2015, 1-14. [doi:10.1155/2015/716598](https://doi.org/10.1155/2015/716598)

15. **Abozeid, A.S.M.** & AboElatta, T.A. (2021). *Polycentric vs Monocentric Urban Structure Contribution to National Development*. *Journal of Engineering and Applied Science*, 68(1). [doi:10.1186/s44147-021-00011-1](https://doi.org/10.1186/s44147-021-00011-1)

## Books & Reports

1. **Talen, E.** & Lee, S. (2017). *Design for Social Diversity* (2nd ed.). Routledge. [doi:10.4324/9781315442846](https://doi.org/10.4324/9781315442846)

2. **OECD** (2022). *OECD Regions and Cities at a Glance 2022*. OECD Publishing. [doi:10.1787/14108660-en](https://doi.org/10.1787/14108660-en)

3. **Lawrence, R.J.** (2014). *Understanding Environmental Quality Through Quality of Life (QOL) Studies*. In *Reference Module in Earth Systems and Environmental Sciences*. [doi:10.1016/b978-0-12-409548-9.09139-9](https://doi.org/10.1016/b978-0-12-409548-9.09139-9)

## Online Resources

1. **Plaverdvalencia.com** (2024). *Documentació – Pla Verd i de la Biodiversitat de València*. [URL](https://plaverdvalencia.com/documentacio/) (Accessed: 2024-10-16)

2. **Royal Geographical Society** (2023). *Sampling Techniques*. [URL](https://www.rgs.org/schools/resources-for-schools/sampling-techniques) (Accessed: 2024-11-28)

3. **Instituto Nacional de Estadística** (2015). *Indicadores de renta media y mediana*. [URL](https://www.ine.es/jaxiT3/Tabla.htm?t=31250&L=0) (Accessed: 2024-11-28)

4. **Opendatasoft.com** (2024). *Seccions censals / Secciones censales*. [URL](https://valencia.opendatasoft.com/explore/dataset/seccions-censals-secciones-censales/map/?location=13) (Accessed: 2024-11-28)

5. **Encyclopædia Britannica** (2019). *Spain – Government and Society*. [URL](https://www.britannica.com/place/Spain/Government-and-society) (Accessed: 2024-11-28)

6. **Worldpopulationreview.com** (2024). *Spain Cities by Population 2024*. [URL](https://worldpopulationreview.com/cities/spain) (Accessed: 2024-11-28)

7. **Field Studies Council** (2023). *Fieldwork for Inner Cities*. [URL](https://www.field-studies-council.org/resources/14-16-geography/urban/inner-cities/fieldwork/) (Accessed: 2024-11-28)

8. **Ansari, S.** (2023). *The Kuznets Curve*. [URL](https://www.economicsonline.co.uk/definitions/the-kuznets-curve.html/) (Accessed: 2024-11-28)

9. **RentSpree** (2024). *How to Calculate Your Tenant's Rent to Income Ratio*. [URL](https://www.rentspree.com/calculator/rent-to-income-ratio) (Accessed: 2024-11-28)

10. **Instituto Nacional de Estadística** (2025). *ArcGIS Web Application*. [URL](https://ine.es/portalgis/apps/webappviewer/index.html?id=5f280e80aad6440b9ad1ab6ee06a5ead) (Accessed: 2025-01-03)

11. **Instituto Nacional de Estadística** (2025). *INEbase / Demografía y población / Cifras de población y Censos demográficos / Encuesta continua de hogares / Últimos datos*. [URL](https://www.ine.es/dyngs/INEbase/es/operacion.htm?c=Estadistica_C&cid=1254736176952&menu=ultiDatos&idp=1254735572981) (Accessed: 2025-01-03)

12. **Instituto Nacional de Estadística** (2021). *Population by Gender and Country of Birth*. [URL](https://www.ine.es/jaxiT3/Tabla.htm?t=69352&L=1) (Accessed: 2025-02-26)

13. **Pérez, R.M.** & Pérez, R.M. (2017). *Distrito 01: Ciutat Vella – Valencia Actua*. [URL](https://calles.valenciaactua.es/distrito-01-ciutat-vella/) (Accessed: 2025-02-26)

14. **Aq.upm.es** (2025). *Plan Riva para Ciutat Vella, Valencia (España)*. [URL](http://habitat.aq.upm.es/dubai/98/bp435.html) (Accessed: 2025-02-26)

15. **Opendatasoft.com** (2022). *Educational Centers in Valencia*. [URL](https://valencia.opendatasoft.com/explore/dataset/centros-educativos-en-valencia/custom/?sort=codpos) (Accessed: 2025-02-27)

16. **Opendatasoft.com** (2024). *Hospitales y otros centros sanitarios*. [URL](https://valencia.opendatasoft.com/explore/dataset/hospitales/export/?sort=coddistrit) (Accessed: 2025-02-27)

17. **Opendatasoft.com** (2022). *Public Transport Stations*. [URL](https://valencia.opendatasoft.com/explore/dataset/transporte-barrios/export/?location=13) (Accessed: 2025-02-27)

18. **Pérez, R.M.** & Pérez, R.M. (2017). *Distrito 11: Poblats Maritims – Valencia Actua*. [URL](https://calles.valenciaactua.es/distrito-11-poblats-maritims/) (Accessed: 2025-02-27)

19. **Pérez, R.M.** & Pérez, R.M. (2017). *Distrito 10: Quatre Carreres – Valencia Actua*. [URL](https://calles.valenciaactua.es/distrito-10-quatre-carreres/) (Accessed: 2025-02-27)

20. **King, L.** (2020). *Central Place Theory*. [URL](https://researchrepository.wvu.edu/rri-web-book/8/) (Accessed: 2025-02-28)

21. **The Geography of Transport Systems** (2017). *Transportation and the Urban Spatial Structure*. [URL](https://transportgeography.org/contents/chapter8/transportation-urban-form/transport-urban-spatial-structure/) (Accessed: 2025-02-28)

22. **Hammel, D.J.** (2009). *Gentrification – An Overview*. [URL](https://www.sciencedirect.com/topics/social-sciences/gentrification) (Accessed: 2025-02-28)

23. **Richardson, J.**, Mitchell, B., & Franco, J. (2019). *Shifting Neighborhoods: Gentrification and Cultural Displacement in American Cities*. [URL](https://ncrc.org/gentrification/) (Accessed: 2025-02-28)

24. **Narvaez, L.**, Penn, A., & Griffiths, S. (2013). *Spatial Configuration and Bid Rent Theory: How Urban Space Shapes the Urban Economy*. [URL](https://www.researchgate.net/publication/315718155_Spatial_Configuration_and_Bid_Rent_Theory_How_urban_space_shapes_the_urban_economy) (Accessed: 2025-02-28)

25. **Taylor, D.** (2025). *Income Diversity and the Context of Community Development*. [URL](https://issuelab.org/resources/591/591.pdf) (Accessed: 2025-02-28)

26. **Instituto Nacional de Estadística** (2015). *Gini Index and Income Distribution*. [URL](https://www.ine.es/jaxiT3/Tabla.htm?t=37721&L=1) (Accessed: 2025-02-28)

27. **PV.CCOO** (2021). *Informe situación socio-laboral de la ciudad de València Datos básicos del mundo del trabajo*. [URL](https://www.pv.ccoo.es/c4e990905f13ba295a8574c10be2ba00000053.pdf) (Accessed: 2025-02-28)

28. **Valencia.es** (2017). *Ayuntamiento de Valencia. Área de Urbanismo*. [URL](http://www.valencia.es/ayuntamiento/urbanismo2.nsf/0/E36A204F6CC86126C12584B8002BB918/) (Accessed: 2025-02-28)

29. **Lovell, L.** (2025). *Valencia's Stunning Parks and Outdoor Spaces*. [URL](https://www.lonelyplanet.com/articles/valencia-city-parks) (Accessed: 2025-03-01)

30. **HousingAnywhere** (2023). *Public Transport in Valencia for Expats*. [URL](https://housinganywhere.com/Valencia--Spain/valencia-public-transport-guide) (Accessed: 2025-03-01)
